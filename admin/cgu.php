...
<h1>C. Collecte d’informations personnelles</h1>
...
<p>Des informations relatives aux achats que vous faites, aux services que vous utilisez ou aux transactions que vous effectuez sur notre site, qui incluent votre nom, adresse, numéro de téléphone, adresse e-mail et informations bancaires ;</p>
...
<h1>D. Utilisation de vos informations personnelles</h1>
...
<p>Les informations personnelles qui nous sont fournies par le biais de notre site web seront utilisées dans les objectifs décrits dans cette politique ou dans les pages du site pertinentes. Nous pouvons utiliser vos informations personnelles pour:</p>
    ...
    <p>Permettre votre utilisation des services proposés sur notre site web ;</p>
    <p>Vous envoyer les marchandises achetées sur notre site ;</p>
    <p>ous fournir les services achetés sur notre site ;</p>
    <p>Vous envoyer des relevés, des factures et des rappels de paiement, et collecter vos paiements ;</p>
    <p>Vous envoyer des communications commerciales non relatives au marketing ;</p>
    <p>Vous envoyer des notifications par e-mail que vous avez expressément demandées ;</p>
    <p>Vous envoyer notre newsletter par mail, si vous l’avez demandé (vous pouvez nous informer à tout moment de votre volonté de ne plus recevoir notre newsletter) ;</p>
    <p>Vous envoyer des communications marketing relatives à notre entreprise ou à des entreprises tierces sélectionnées avec soin qui selon nous pourraient vous intéresser, sous forme de publication, ou si vous avez expressément donné votre accord, par e-mail ou technologie similaire (vous pouvez nous informer à tout moment de votre volonté de ne plus recevoir de communications marketing) ;</p>
    <p>Fournir des informations statistiques à propos de nos utilisateurs à des tierces parties (sans que ces tierces parties puissent identifier d’utilisateur individuel avec ces informations) ;</p>
    <p>Traiter les demandes et les réclamations relatives à votre site web effectuées par vous ou vous concernant ;</p>
    <p>Maintenir la sécurité de notre site web et empêcher la fraude ;</p>
    <p>Vérifier le respect des conditions générales qui régissent l’utilisation de notre site web (y compris surveiller les messages privés envoyés par le biais du service de messagerie privé de notre site web) ; et D’autres utilisations.</p>
...
<h1>E. Divulgation de vos informations personnelles</h1>
...
<p>Nous pouvons divulguer vos informations personnelles:</p>
    ...
    <p>Dans la mesure où nous sommes tenus de le faire par la loi ;</p>
    <p>Dans le cadre de toute procédure judiciaire en cours ou à venir ;</p>
    <p>Pour établir, exercer ou défendre nos droits légaux (y compris fournir des informations à d’autres à des fins de prévention des fraudes et de réduction des risques de crédit) ;</p>
    <p>À l’acheteur (ou acheteur potentiel) de toute entreprise ou actif en notre possession que nous souhaitons (ou envisageons de) vendre ; et</p>
    <p>À toute personne que nous estimons raisonnablement faire partie intégrante d’un tribunal ou autre autorité compétente pour la divulgation de ces informations personnelles si, selon notre opinion, un tel tribunal ou une telle autorité serait susceptible de demander la divulgation de ces informations personnelles.</p>
...
<h1>F. Transferts internationaux de données</h1>
...
<p>Vous acceptez expressément le transfert d’informations personnelles décrit dans cette Section F.</p>
<h1>G. Conservation de vos informations personnelles</h1>
...
<p>Sans préjudice à l’article G-2, nous supprimerons généralement les données personnelles de ces catégories à la date et à l’heure précisées plus bas:</p>
<p>Ce type de données personnelles sera supprimé {ENTREZ LA DATE/L’HEURE} ; et
{ENTREZ D’AUTRES DATES/HEURES}.</p>
<p>Nonobstant les autres dispositions de cette Section G, nous conserverons des documents (y compris des documents électroniques) contenant des données personnelles:</p>
<p>Dans la mesure où nous sommes tenus de le faire par la loi ;</p>
<p>Si nous pensons que les documents peuvent être pertinents pour toute procédure judiciaire en cours ou potentielle ; et</p>
<p>Pour établir, exercer ou défendre nos droits légaux (y compris fournir des informations à d’autres à des fins de prévention des fraudes et de réduction des risques de crédit).</p>
<h1>H. Sécurité de vos informations personnelles</h1>
...
<p>Vous pouvez nous demander de vous fournir toute information personnelle que nous détenons sur vous ; le transfert de telles informations sera soumis aux conditions suivantes:</p>
    ...
    <p>Le règlement de frais {ENTREZ LES FRAIS SI PERTINENT}; et</p>
    <p>La présentation de preuves suffisantes de votre identité {AJUSTEZ LE TEXTE POUR REFLÉTER VOTRE POLITIQUE} (à ces fins, nous acceptons en général une photocopie de votre passeport certifiée par notaire plus une copie originale d’une facture de service public indiquant votre adresse actuelle).</p>
...
<h1>L. Mise à jour des informations</h1>
...
avec Chrome (version 29), vous pouvez bloquer tous les cookies en accédant au menu «Personnaliser et contrôler» puis en cliquant sur «Paramètres», «Montrer les paramètres avancés» et «Paramètres de contenu» puis en sélectionnant «Empêcher les sites de définir des données» dans l’en-tête «Cookies».</p>
...
<p>Vous pouvez supprimer les cookies déjà stockés sur votre ordinateur. Exemple:
...
<p>Website Planet décline toute responsabilité et vous conseille de consulter des experts juridiques si vous implémentez le modèle ci-dessus sur votre site web.</p>