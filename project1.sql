...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 08 mars 2021 à 10:51
...
INSERT INTO `article_category` (`article_category_id`, `article_category_name`) VALUES
(1, 'Librairie'),
(2, 'Produit'),
(3, 'Encyclopedie'),
(4, 'Fonctionnalité');
...
CREATE TABLE IF NOT EXISTS `blog_article` (
  ...
  `article_pic` varchar(100) NOT NULL,
...
INSERT INTO `blog_article` (`article_id`, `article_pic`, `article_title`, `article_text`, `article_author`, `article_date`, `article_category_id`) VALUES
(1, '', 'SKIDAMARINK par Guillaume MUSSO', 'SKIDAMARINK \r\nINTROUVABLE DEPUIS DES ANNÉES, \r\nLE TOUT PREMIER ROMAN \r\nDE GUILLAUME MUSSO ENFIN RÉÉDITÉ ! \r\n \r\nAlors que le vol de La Joconde fait la une de tous les journaux, quatre personnes qui ne se connaissent pas reçoivent un fragment découpé de la célèbre oeuvre de Léonard de Vinci, accompagné d’un mystérieux rendez-vous dans une chapelle de Toscane.\r\n\r\nPourquoi eux ? Qui les a choisis ? Quel plan se cache derrière ce coup d’éclat ? Ils l’ignorent encore, mais à l’instant même où ils décident de résoudre ensemble cette énigme, leur vie prend un tournant dangereux, exaltant et sans retour.\r\n\r\nDepuis Skidamarink, paru en 2001, Guillaume Musso a publié dix-sept romans qui ont conquis des dizaines de millions de lecteurs dans le monde. Il est aujourd’hui l’auteur le plus lu en France, pour la dixième année consécutive. Ce tout premier thriller, mêlant mystère, suspense, amour et aventure, révèle déjà son talent sans pareil pour raconter une histoire à la croisée des genres.', 'aurelien chetanneau', '2021-03-04 15:27:26', 1),
(2, '', 'LA VIE EST UN ROMAN par Guillaume MUSSO', 'POUR LUI, TOUT EST ÉCRIT D\'AVANCE\r\nPOUR ELLE TOUT RESTE À ÉCRIRE\r\n\r\n« Un jour d’avril, ma fille de trois ans, Carrie, a disparu alors que nous jouions toutes les deux à cache-cache dans mon appartement de Brooklyn. »\r\n \r\n\r\nAinsi débute le récit de Flora Conway, romancière renommée à la discrétion légendaire. La disparition de Carrie n’a aucune explication. La porte et les fenêtres de l’appartement étaient closes, les caméras de ce vieil immeuble new-yorkais ne montrent pas d’intrusion. L’enquête de police n’a rien donné.\r\n\r\nAu même moment, de l’autre côté de l’Atlantique, un écrivain au cœur broyé se terre dans une maison délabrée.\r\nLui seul détient la clé du mystère. Et Flora va le débusquer.', 'aurelien chetanneau', '2021-03-04 15:28:25', 1),
(3, '', 'LA VIE SECRÈTE DES ÉCRIVAINS par Guillaume MUSSO', 'En 1999, après avoir publié trois romans  devenus cultes, le célèbre écrivain Nathan  Fawles annonce qu’il arrête d’écrire et se retire  à Beaumont, une île sauvage et sublime au  large des côtes de la Méditerranée.\r\n\r\nAutomne 2018. Fawles n’a plus donné une  seule interview depuis vingt ans. Alors que ses  romans continuent de captiver les lecteurs,  Mathilde Monney, une jeune journaliste  suisse, débarque sur l’île, bien décidée à percer  son secret.\r\n\r\nLe même jour, un corps de femme est  découvert sur une plage et l’île est bouclée par  les autorités. Commence alors entre Mathilde  et Nathan un dangereux face à face, où se  heurtent vérités occultées et mensonges  assumés, où se frôlent l’amour et la peur…', 'aurelien chetanneau', '2021-03-04 15:29:59', 1),
(4, '', 'Le Crépuscule des fauves par Marc LEVY', 'Maya a disparu.\r\nUne course contre la montre s\'engage sur le terrain pour les hackeurs du Groupe 9 qui cherchent à déjouer la conspiration des fauves.\r\nLes fauves, une poignée de puissants qui s\'attaquent à nos libertés.\r\nLeur plan : créer le chaos, s\'approprier toutes les richesses et régner sans limites.\r\n\r\nMais qui est 9 ?\r\nCe nouveau thriller est la suite passionnante de l\'aventure des 9 héros intrépides et attachants rencontrés dans C\'est arrivé la nuit.\r\n9 Robins des Bois d\'aujourd\'hui, 9 hors la loi qui oeuvrent pour le bien au péril de leur vie.\r\nUn roman d\'espionnage engagé qui dévoile de manière éblouissante les dérives de notre époque.', 'aurelien chetanneau', '2021-03-04 15:33:15', 1),
(5, '', 'C\'est arrivé la nuit par Marc LEVY', 'Depuis vingt ans, j’écris pour voir le monde en couleurs…\r\nPour me calmer aussi.\r\nÀ quoi sert d’être écrivain, si ce n’est pour raconter des histoires qui interpellent, pour se poser des questions ?\r\nJe m’en suis posé à chaque page, alors j’ai mené l’enquête, résolu, aussi mordu qu’un reporter.\r\n \r\nJe suis parti à la rencontre des vrais protagonistes, des hors-la-loi au cœur d’or, des vilains bien sous tous rapports, des manipulateurs, des faussaires, des passeurs, des assassins en col blanc, des putains magnifiques, des journalistes risquant leur peau pour que la vérité éclate, et ce faisant j’ai découvert l’indicible.\r\n \r\nJ’avais pour habitude de me laisser entraîner par deux personnages.\r\nCette fois, ils sont 9.\r\nJ’ai tout fait pour entrer dans leur bande.\r\nEt ils m’ont accepté.\r\n \r\nCette année, nul besoin de leur dire au revoir à la dernière page.\r\nParce que l’histoire continue, et elle est loin d’être terminée.\r\nBienvenue dans le monde de 9 ! ', 'aurelien chetanneau', '2021-03-04 15:33:53', 1),
(6, '', 'Star Wars', 'La collection définitive de la plus grande saga galactique de tous les temps\r\n\r\nDécouvrez tous les secrets de la Galaxie dans une collection inédite. L\'ouvrage le plus complet jamais publié sur Star Wars avec toutes les informations organisées et actualisées.\r\n\r\n\r\n\r\nVous pouvez maintenant avoir l\'encyclopédie la plus complète de l\'univers Star Wars et avoir en main PLANS, SCHÉMAS ET CONTENUS RICHEMENT ILLUSTRÉS au service d’analyses sous différentes perspectives de tout ce que vous devez savoir sur STAR WARS, l’œuvre qui a révolutionné la science-fiction pour toujours.', 'aurelien chetanneau', '2021-03-04 15:47:55', 3),
(7, '', 'Le pouvoir des pierres', 'Profitez de tout le potentiel de vos bijoux pleins d\'énergie\r\n\r\n\r\n\r\nDans chaque numéro, vous obtiendrez une pierre 100% naturelle provenant de différentes régions de la planète. Chaque pierre est unique et a fait l’objet d’un polissage au tambour (tonneau rotatif) après extraction de sa matière première et a été sélectionnée pour sa qualité exceptionnelle qui la rend unique et spéciale.\r\n\r\n\r\n\r\nIl s’agit d’une collection exceptionnelle de pierres polies dont la forme de galet préserve toute ses qualités énergétiques et exerce ses bienfaits.', 'aurelien chetanneau', '2021-03-04 15:48:31', 3),
(8, '', 'Charlotte aux fraises', 'Collectionnez les adorables poupées de votre enfance\r\n\r\nAltaya présente une collection de poupées Charlotte aux Fraises, les poupées originales des années 1980. Vous vous souvenez de l’inoubliable parfum de fraise de cette poupée, de la chevelure bleue d’Amandine ou de la délicate couleur jaune de Meringue Citron (Mimi Citron) ?\r\n\r\n\r\n\r\nCollectionnez-les toutes et retrouvez l’authentique univers de Fraisi-Paradis.', 'aurelien chetanneau', '2021-03-04 15:49:07', 3),
(9, '', 'Blog en Ligne', 'Toutes vos nouvelles fonctionnalités et vos nouveaux produits vont être mis à jour!!!!', 'aurelien chetanneau', '2021-03-04 15:50:43', 4);
...
(49, 'patrice', 'EON', '$2y$10$iPW6mwTUtFflYvaWwuFlQe2pYZC/G6hufFgU5viKWFJueznVNpvjm', 'zedrfgthj', 'patrice@gmail.com', 1),
(2, 'aurelien', 'chetanneau', '$2y$10$iPW6mwTUtFflYvaWwuFlQe2pYZC/G6hufFgU5viKWFJueznVNpvjm', '142 bbgrbr', 'aurelien@yahoo.fr', 5);
COMMIT;
